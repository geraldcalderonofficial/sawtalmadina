...
<html lang="en-US">
  ...
  ga('send', 'pageview');
	...
	<body>
		...
		<div id="tm-page-body">
			<div id="tm-template-comingson" class="tm-container">
				<div class="page-content">
					<div class="page-content-inner tm-content">
						<div class="tm-row" style="padding:150px 0 40px 0">
							<div class="tm-wrap">
								<h1 class="">Our Website is Coming soon</h1>
								<br>
								<div class="tm-countdown styled"></div>
							</div>
						</div>
						
						<div class="tm-row"  style="background:#eee; padding:40px 0">
							<div class="tm-wrap">
								<div class="header-line-center-bottom">
									<h3 class="tm-title">Keep me informed</h3>
								</div>
						...
						<div class="tm-row" style="background:#eee">
							<ul class="social-networks" style="background:none;">
								<li>
